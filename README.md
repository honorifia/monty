...
Welcome to the Monty Bytecode Interpreter. This interpreter was built in the C language and is compliant with `ANSI C89` `ISO90`, `ISO99`, & `ISO11`. It reads Monty bytecode files of any extension (preferably `.m` although it doesn't matter), and interprets the opcodes contained.
...
```
$ git clone "https://github.com/i-christian/monty.git"
```
...
* Maxwell Kajiwonele <[honorifia](https://github.com/honorifia)>
